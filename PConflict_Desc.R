...
light_trend = ggplot(data=pr_lg, aes(x=factor(time), y=light, group=factor(gr))) +
  geom_line(aes(color=factor(gr)))+
  geom_point(aes(color=factor(gr)))+
  theme(legend.position="bottom")+
  ylab("Rural activity")+
  geom_vline(xintercept = 5, linetype="dashed") +
  scale_color_manual(name = "Armed \ngroup",
                     values=c("gray70", "gray40","gray10"),
...
rohv = rohv %>%
  ...
  summarise(incidents = n(), victims = sum(TOTAL))
...
gph_vln0 = ggplot(data=rohv, aes(x=time, y=incidents, group=factor(gr))) +
  geom_line(aes(color=factor(gr)))+
  geom_point(aes(shape=factor(gr)))+
  geom_vline(xintercept = 2012, linetype = "dashed", colour = "black")+
  scale_color_manual(name = "Armed \ngroup",
                     values=c("gray70", "gray40","gray10")) +
  scale_shape_manual(name = "Armed \ngroup",
                     labels = c("ELN","FARC","FARC-ELN"),
                     values=c(13, 15,17)) +
...
gph_coca = ggplot(data=coca, aes(x=time, y=coca, group=factor(gr))) +
  geom_line(aes(color=factor(gr)))+
  geom_point(aes(shape=factor(gr)))+
  geom_vline(xintercept = 2012, linetype = "dashed", colour = "black")+ 
  scale_color_manual(name = "Armed \ngroup",
...
ggsave("ggtmt.png", width = 40, height = 20, units = "cm")
...
ggsave("ggmap.png", width = 40, height = 40, units = "cm")
